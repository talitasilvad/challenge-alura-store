...
O projeto foi desenvolvido inteiramente em Python utilizando o Google Colab. As principais bibliotecas empregadas foram:

Pandas: Para manipulação, limpeza e agregação dos dados (ETL).
...
Líder: Loja 1, apresenta o maior faturamento acumulado da rede, aproximadamente **R\$ 1.53 mi**, se consolidando como a principal fonte de receita.
Última: Loja 4, possui o pior desempenho financeiro, aproximadamente **R$ 1.38 mi**, com uma diferença significaiva de quase R$ 150.000,00 a menos que a líder.

Baixa Satisfação: Possui índices de avaliação ruins, detraindo a marca.

Nota Estratégica: A Loja 1, apesar de também ter avaliações ruins e custos logísticos altos, é a líder de receita e deve passar por reestruturação, não venda.
